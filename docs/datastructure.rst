...
The ``name`` attribute holds a name for the orthography.  A unique name of less
than 255 characters is required.  The name should facilitate identification of
the orthography.
...
attempt so generate the ``html`` value from the user-supplied ``pageContent``
